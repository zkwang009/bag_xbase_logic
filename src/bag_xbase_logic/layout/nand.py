...
class NAND(AnalogBase):
    ...
    def get_params_info(cls):
        ...
        return dict(
            ...
            wn='NMOS width',
            wp='PMOS width',
            nfn='nand0 NMOS finger number',
            nfp='nand0 PMOS finger number',
    ...
    def _draw_layout_helper(self, lch, wn, wp, nfn, nfp, g_space, ds_space, ptap_w, ntap_w,
        ...
        self.connect_to_tracks([nand_n0_ports['d'], nand_n1_ports['s']], ndrain_id, min_len_mode=0)
        ...
        o = self.connect_to_tracks([nand_p0_ports['d'], nand_p1_ports['d'], nand_n1_ports['d']], pout_id,
                                   min_len_mode=0)
