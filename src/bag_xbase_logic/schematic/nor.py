...
class bag_xbase_logic__nor(Module):
    """Module for library bag_xbase_logic cell nor.
    ...
    def get_params_info(cls):
        ...
        return dict(
            ...
            wn='NMOS width',
            wp='PMOS width',
            nfn0='NMOS finger number',
            nfn1='NMOS finger number',
            nfp0='PMOS finger number',
            nfp1='PMOS finger number',
    ...
    def design(self, lch, wn, wp, nfn0, nfn1, nfp0, nfp1, intent, dum_info, debug, **kwargs):
        ...
        self.instances['XN1'].design(w=wn, l=lch, nf=nfn0, intent=intent)
        self.instances['XP0'].design(w=wp, l=lch, nf=nfp1, intent=intent)
