...
yaml_file = pkg_resources.resource_filename(__name__, os.path.join('netlist_info', 'dff_strst.yaml'))


# noinspection PyPep8Naming
class bag_xbase_logic__dff_strst(Module):
    """Module for library xbase_logic_templates cell dff_strst.
    ...
    def get_params_info(cls):
        ...
        return dict(
            ...
            fb_tgate_params='feedback tinv parameters',
