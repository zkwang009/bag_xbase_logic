...
def run_main(prj):
    ...
    tb_lib = specs['tb_lib']
    cell_name = specs['tinv_cell_name']
    tb_cell = specs['tinv_tb_cell']
    ...
    sch_params = specs['tinv_sch_params']
    lay_params = specs['tinv_lay_params']
    mdl_params = specs['tinv_mdl_params']

    # testbench sweep parameters
    sim_envs = specs['tinv_sim_envs']
    tb_params = specs['tinv_tb_params'].copy()

    tinv_opts = specs['tinv_opts'].copy()
    run_dsn = tinv_opts['run_dsn']
    run_simulation = tinv_opts['run_simulation']
    run_extraction = tinv_opts['run_extraction']
