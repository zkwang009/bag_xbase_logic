import bag.core
from xbase_logic_repo.src.xbase_logic_repo.layout.dff import DFF
...
def run_main(prj):
    ...
    tb_lib = specs['tb_lib']
    cell_name = specs['dff_cell_name']
    tb_cell = specs['dff_tb_cell']
    ...
    sch_params = specs['dff_sch_params']
    lay_params = specs['dff_lay_params']
    mdl_params = specs['dff_mdl_params']

    # testbench sweep parameters
    sim_envs = specs['dff_sim_envs']
    tb_params = specs['dff_tb_params'].copy()

    dff_opts = specs['dff_opts'].copy()
    run_dsn = dff_opts['run_dsn']
    run_simulation = dff_opts['run_simulation']
    run_extraction = dff_opts['run_extraction']
